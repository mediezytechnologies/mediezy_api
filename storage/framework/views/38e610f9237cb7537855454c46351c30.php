    ...
    <main id="main">
                ...
                <div class="card card-body main_card mt-2 shadow-lg p-3 mb-2">
                    ...
                    <div class=" row main_heading  mb-2 shadow p-2 subheading">
                        ...
                        <div class="col-md-4 col-12 text-end">
                            <a class="btn AddBtn px-4" href="<?php echo e(url('/Docter/create')); ?>">+
                                Add</a>
        ...
        <script>
            ...
            var MasterTable = $('.MasterTable').DataTable({
                ...
                ajax: "<?php echo e(route('Docter.index')); ?>",
columns: [
    {
        data: 'DT_RowIndex',
        name: 'DT_RowIndex'
...
<?php /**PATH /home/1163996.cloudwaysapps.com/tdtjxymxyy/public_html/resources/views/Docter/index.blade.php ENDPATH**/ ?>