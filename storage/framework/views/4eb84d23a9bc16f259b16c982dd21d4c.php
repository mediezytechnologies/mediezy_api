                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-12 mb-3">
                                ...
                                <select class="form-select  inputfield" aria-label="Default select example name"
                                    ...
                                    <?php $__currentLoopData = $specialization; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option class="inputlabel" value="<?php echo e($key->id); ?>">
                                            <?php echo e($key->specialization); ?>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-12 mb-3">
                                ...
                                <select class="inputfield staffselect subspecificationselect multiselect" multiple
                                    ...
                                    <?php $__currentLoopData = $subspecification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option class="inputlabel" value="<?php echo e($key->id); ?>">
                                            <?php echo e($key->subspecification); ?>
                            ...
                            <div class="col-xl-6 col-lg-6 col-12 mb-3">
                                ...
                                <select class="inputfield staffselect specificationselect multiselect" multiple
                                    ...
                                    <?php $__currentLoopData = $Specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option class="inputlabel" value="<?php echo e($key->id); ?>">
                                            <?php echo e($key->specification); ?>
    ...
    <script>
        ...
        $("#Enquiry_form").validate({
            ...
            submitHandler: function(form) {
              ...
              console.log(formData.get('hospitals'));
...
<?php /**PATH /home/1163996.cloudwaysapps.com/tdtjxymxyy/public_html/resources/views/Docter/create.blade.php ENDPATH**/ ?>